...
namespace WHITELABEL.Web.Areas.Admin.Controllers
{
    ...
    public class MemberTransactionReportController : AdminBaseController
    {
        ...
        public PartialViewResult IndexGrid(string status="")
        {
            var listCommission = AdminTransactionViewModel.GetAdminCommissionReport(MemberCurrentUser.MEM_ID.ToString(), status);
        ...
        public PartialViewResult DistributorCommissionGrid(string Super="", string search = "", string status = "")
        {
            if (string.IsNullOrEmpty(Super)&& string.IsNullOrEmpty(search) && string.IsNullOrEmpty(status))
            {
                var listCommission = AdminTransactionViewModel.GetAllDistributorCommissionReport(MemberCurrentUser.MEM_ID.ToString(), status);
            ...
            {
                var listCommission = AdminTransactionViewModel.GetDistributorCommissionReport(Super,search.ToString(), status);
                return PartialView("DistributorCommissionGrid", listCommission);
            }
            else if (!string.IsNullOrEmpty(Super) && !string.IsNullOrEmpty(search) && !string.IsNullOrEmpty(status))
            {
        ...
        public PartialViewResult MerchantCommissionGrid(string Super = "", string Distributor = "" , string search="", string Status = "")
        {
            if (string.IsNullOrEmpty(Super) && string.IsNullOrEmpty(Distributor) && string.IsNullOrEmpty(search) && string.IsNullOrEmpty(Status))
            {
                var MerchantList = AdminTransactionViewModel.GetAllMerchantCommissionReport(MemberCurrentUser.MEM_ID.ToString(), Status);
            ...
            {
                var MerchantList = AdminTransactionViewModel.GetMerchantCommissionReport(Super, Distributor, search.ToString(), Status);
                return PartialView("MerchantCommissionGrid", MerchantList);
            }
            else if (!string.IsNullOrEmpty(Super) && !string.IsNullOrEmpty(Distributor) && !string.IsNullOrEmpty(search) && !string.IsNullOrEmpty(Status))
            {
        ...
        [HttpGet]
        public FileResult ExportIndexMerchantReport(string Super,string Distributor, string Disid,string statusval)
        {
            ...
            using (ExcelPackage package = new ExcelPackage())
            {
                ...
                IGrid<TBL_ACCOUNTS> grid = CreateExportableGrid(Super, Distributor, Disid, statusval);
        ...
        private IGrid<TBL_ACCOUNTS> CreateExportableGrid(string Super, string Distributor, string Disid, string statusval)
        {
            var db = new DBContext();
            ...
            {
                 MerchantList = AdminTransactionViewModel.GetAllMerchantCommissionReport(MemberCurrentUser.MEM_ID.ToString(), statusval);                
            }
            ...
            {
                 MerchantList = AdminTransactionViewModel.GetMerchantCommissionReport(Super, Distributor, Disid.ToString(), statusval);                
            }
            else if (!string.IsNullOrEmpty(Super) && !string.IsNullOrEmpty(Distributor) && !string.IsNullOrEmpty(Disid) && !string.IsNullOrEmpty(statusval))
            {
                 MerchantList = AdminTransactionViewModel.GetMerchantCommissionReport(Super, Distributor, Disid.ToString(), statusval);                
        ...
        // Distributor
        [HttpGet]
        public FileResult ExportIndexDistributorReport(string Super, string Disid, string statusval)
        {
            // Using EPPlus from nuget
            using (ExcelPackage package = new ExcelPackage())
            {
                ...
                package.Workbook.Worksheets.Add("Data");
                IGrid<TBL_ACCOUNTS> grid = CreateExportDistributoTableGrid(Super,Disid, statusval);
                ExcelWorksheet sheet = package.Workbook.Worksheets["Data"];
        ...
        private IGrid<TBL_ACCOUNTS> CreateExportDistributoTableGrid(string Super, string Disid, string statusval)
        {
            var db = new DBContext();
            string[] SuperMemId = null;
            string[] DistributorMemId = null;
            ...
            {
                MerchantList = AdminTransactionViewModel.GetAllDistributorCommissionReport(MemberCurrentUser.MEM_ID.ToString(), statusval);
            ...
            {
                MerchantList = AdminTransactionViewModel.GetDistributorCommissionReport(Super, Disid.ToString(), statusval);
